...
export default function InvoiceReportPage() {
  ...
  const { stats, unpaidInvoices, unpaidPagination, loading, error } =
    useSelector((state) => state.getInvoicesStats);
    ...
    <div className="space-y-8">
      ...
      {loading && (
        <div className="text-center py-8">
          ...
          ></div>
          <p className="mt-2" style={{ color: themeColor }}>
      ...
      <section className="rounded-[36px] border border-[#E2E7E4] bg-white px-6 py-8 shadow-[0_40px_80px_-60px_rgba(11,75,49,0.45)] sm:px-10 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 rounded-[18px] bg-[#E5EFEB] px-8 py-6">
          <div>
            ...
            <p className="text-[1.5rem] font-normal text-[#0000008C] mt-1">
              Total Invoices
            </p>
          </div>
          <div>
            ...
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  ></span>
                  <div>
                    <p className="text-[0.8125rem] font-normal text-[#979699]">
                      Paid
                    </p>
            ...
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
              ...
              <div className="space-y-3 text-[0.8125rem] font-normal text-[#0000008C]">
                <div className="flex items-center gap-3">
                  <span
                    className="inline-flex h-3 w-3 rounded-full"
                    style={{ backgroundColor: "#1D8C6C" }}
                  ></span>
                  <span className="text-[0.8125rem] font-normal text-[#0000008C]">
                    Cash Stripe
                  </span>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[0.8125rem] font-normal text-[#0000008C]">
                    Paid
                  </p>
            ...
            <tbody>
              {tableData.length > 0 ? (
                      ...
                      <td className="px-4 py-3">
                        <div className="relative inline-block">
                          <button
                            ...
                            onMouseEnter={(e) =>
                              (e.target.style.backgroundColor = `${themeColor}90`)
                            }
                            onMouseLeave={(e) =>
                              (e.target.style.backgroundColor = `${themeColor}38`)
                            }
                          >
                            Action
                            <span>▾</span>
                ...
                <tr>
                  <td
                    colSpan="6"
                    className="px-4 py-8 text-center text-[#0000008C]"
                  >
                    {loading
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() =>
                  handlePageChange(Math.min(unpaidPage + 1, totalUnpaidPages))
                }
                disabled={
                  unpaidPage === totalUnpaidPages || totalUnpaidPages === 0
                }
                className="rounded-full border border-[#C5D2CD] bg-white px-3 py-2 text-sm transition hover:bg-[#F3F6F5] disabled:opacity-50 disabled:cursor-not-allowed"
                style={{ color: themeColor }}
              >
