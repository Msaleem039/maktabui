            ...
            <div style="margin-bottom: 30px; border-bottom: 2px solid #0B4B31; padding-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <p style="color: #666666; margin: 0; font-size: 14px;">#${invoiceData.invoiceNumber}</p>
                    </div>
                        ...
                        <tbody>
                            ${invoiceData.items?.map((item, index) => `
                                <tr style="${index < invoiceData.items.length - 1 ? 'border-bottom: 1px solid #D2E2DB;' : ''}">
                                    <td style="padding: 12px 16px; color: #000000; font-size: 12px; vertical-align: top;">${item.description}</td>
                                    <td style="padding: 12px 16px; text-align: center; color: #000000; font-size: 12px; vertical-align: top;">${item.quantity}</td>
                                    <td style="padding: 12px 16px; text-align: right; color: #000000; font-size: 12px; vertical-align: top;">${formatCurrency(item.amount)}</td>
                                    <td style="padding: 12px 16px; text-align: right; color: #000000; font-size: 12px; font-weight: bold; vertical-align: top;">${formatCurrency(item.amount * item.quantity)}</td>
                                </tr>
                            `).join('')}
                        </tbody>
                    </table>
