...
import {
  ...
  clearError,
  clearSuccess,
} from "@/redux/slices/eventSlices/eventSlices";
...
export default function EditEventPage() {
  ...
  const { loading, error, success, currentEvent } = useSelector(
    (state) => state.events,
  );
    ...
    return (
      <div className="space-y-8">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[1.75rem] font-medium text-[#000000]">MaktabOS</p>
        </div>
