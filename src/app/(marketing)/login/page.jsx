...
{/* 
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative w-full">
              ...
              {isDropdownOpen && (
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-xl shadow-2xl overflow-hidden z-10 border border-gray-200 animate-slideDown pb-4">
