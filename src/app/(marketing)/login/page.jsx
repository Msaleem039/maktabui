...
const Page = () => {
    ...
    const { status, error: loginError, userInfo } = useSelector((state) => state.user);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (loginUser.fulfilled.match(resultAction)) {
                ...
                setCookie('token', resultAction.payload.token, tokenOptions);
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="relative w-full">
                            ...
                            >
                                ...
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={`w-5 h-5 text-[#0B4B31] ml-3 transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : ''}`}
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    strokeWidth={2.5}
