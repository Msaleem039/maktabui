            ...
            {tableData.map((parent) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="relative flex items-center gap-3 pl-3">
                      <span
                        className={`absolute left-0 inline-flex h-2 w-2 rounded-full transition ${
                          isSelected ? "bg-[#0B4B31]" : "bg-transparent group-hover:bg-[#0B4B31]/50"
                        }`}
                      ></span>
                  ...
                  <td className="px-4 py-3 text-[#555]">{parent.address}</td>
                  <td className="px-4 py-3 text-[#555]">{parent.phone}</td>
                  <td className="px-4 py-3">
                    {parent.invoiceStatus ? (
                      <span
                        className={`inline-flex rounded-full px-4 py-1 text-xs font-semibold ${
                          parent.invoiceStatus.tone === "overdue"
                            ? "bg-[#F16957]/90 text-white"
                  ...
                  <td className="px-4 py-3 text-[#555]">{parent.spouse}</td>
