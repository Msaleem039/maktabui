...
import { updateAdminAction, resetState } from "@/redux/slices/adminSlices/adminSlices";
import { FormInput } from "@/components/FormInput";
import { useRouter } from "next/navigation";

export default function EditAdminDetail({ admin }) {
    const dispatch = useDispatch();
    const { loading: updateLoading, error: updateError, updatedAdmin } = useSelector(
            ...
            try {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status >= 200 && xhr.status < 300) {
                        resolve(`${SUPABASE_URL}/storage/v1/object/public/maktab-system/${fileName}`);
                    } else {
                        console.log("Upload Error Response:", xhr.responseText);
