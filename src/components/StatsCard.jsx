      ...
      {statCards.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <h3 className="text-sm font-normal text-[#0B4B31] mb-1">{item.title}</h3>
            <h2 className="text-3xl font-semibold text-[#0B4B31] mb-1">{item.value}</h2>
