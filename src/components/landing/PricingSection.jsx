  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto min-h-screen w-full max-w-6xl px-4 py-20 2xl:max-w-7xl">
        <h2 className="mb-6 text-center text-2xl leading-[1.2] font-bold text-[#FAFAFA] sm:text-3xl md:text-[2.5rem] md:leading-normal lg:text-left lg:ml-24 lg:max-w-xs">
          Our Pricing
        </h2>
